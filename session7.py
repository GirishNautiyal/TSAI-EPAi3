...
# Q.1: Write a closure that takes a function and then check whether the function passed
...
# Q.2: Write a closure that gives you the next Fibonacci number
...
# Q.3: We wrote a closure that counts how many times a function was called.
...
# Q.4: Modify above such that now we can pass in different dictionary
#      variables to update different dictionaries
